    ...
    public Prompt get(
        ...
        String prompt = String.format("""
            ...
            **Instruções:**
            ...
            1.  **Entendimento:** Receba o código da classe alvo (`%s`), o código de suas dependências (`%s`), e uma lista estruturada de cenários de teste (localizados na seção: **Cenários de Teste (JSON):**).
            2.  **Geração de Código:** Crie uma classe de teste JUnit 5 completa no pacote correto (geralmente o mesmo da classe alvo, mas em `src/test/java`).
                *   Implemente CADA cenário de teste fornecido no JSON da seção **Cenários de Teste (JSON):** como um método `@Test` separado.
            ...
            **Resposta JSON:**
            ...
            ```
            """, targetClassName, dependenciesList, targetClassName, targetClassName, targetClassName, context.getTargetClassCode(), dependencies, testScenarios);
