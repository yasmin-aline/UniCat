...
public class ImplementUnitTestsPromptGenerator {
    ...
    public Prompt get(final String targetClassName, final String targetClassCode, final String targetClassPackage, final String guidelines, final String dependencies, final String scenarios) {
        final String prompt = String.format("""
            ...
            """, targetClassName, targetClassName, targetClassPackage, targetClassCode, dependencies, scenarios, guidelines, targetClassName, targetClassName);
