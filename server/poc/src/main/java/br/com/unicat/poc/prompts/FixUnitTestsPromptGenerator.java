            ...
            """
					# Prompt para Use Case: Corrigir Testes Unitários Falhos (Versão 3 - Saída JSON, CoT & Few-Shot Complexo com Análise de Cobertura)
					   ...
					   **Resposta JSON:**
					   ...
					   ```
				""", targetClassName, dependenciesList, targetClassName, dependenciesList, targetClassName, dependenciesList, context.getTargetClassCode(), dependencies, originalTestClassCode, failingTestsDetails, coverageDetails);
