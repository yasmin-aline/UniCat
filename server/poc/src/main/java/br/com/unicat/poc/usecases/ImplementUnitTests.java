...
public class ImplementUnitTests {
  ...
  public ImplementUnitTests(
      ImplementUnitTestsPromptGenerator promptGenerator, B3GPTGateway b3GPTGateway) {
  ...
  public AssistantMessage run(
      ...
      String scenarios) {
    log.info(
        "INIT ImplementUnitTests run. class: {}, package: {}, guidelines: {}, dependencies: {}, scenarios: {}",
        targetClassName,
        targetClassPackage,
        guidelines,
        dependencies,
